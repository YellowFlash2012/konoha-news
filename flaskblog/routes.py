...
def account():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('account')) #to avid the weird "confirm form resubmission pop up message"
    #prepopulate form fields with current_user data
...
def update_post(post_id):
    ...
    if post.author != current_user:
        abort(403)
        flash('You can NOT edit a post you did NOT create', 'danger')
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email with password reset instructions has just been sent to your inbox', 'info')
